  ...
  <div class="p-6">
    ...
    <div v-else class="space-y-3">
      ...
      >
        ...
        <p
          v-if="editingId === role.id && role.system"
          class="text-[11px] text-alert mt-3 flex items-center gap-1.5"
        >
          <Icon name="mdiAlertOutline" :size="13" />
          {{ t('This is a system role — editing its permissions can lock other users out. Be careful.') }}
        </p>
      </div>
    </div>
  </div>
